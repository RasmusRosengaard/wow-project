...
| Server-side collection | `collect_all.py` | Done, live — replaces the deleted `run_cycle.py` + Windows Task Scheduler. Deep-collects FULL/HIGH-pop EU realms only (scope decided 2026-07-23), runs hourly in-process inside the deployed app. |
