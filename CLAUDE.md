...
Verified: `pytest -q` green (109 tests as of the dashboard QoL pass, 2026-07-23; all against SQLite/mocked externals — no real Postgres or Stripe account needed in CI). Live API confirmed working end to end:
