...
| `requirements.txt` | `requests`, `pyarrow`, `duckdb`, `fastapi`, `uvicorn`, `httpx` (Python 3.10+) |
| `.env.example` | `BLIZZ_CLIENT_ID`, `BLIZZ_CLIENT_SECRET`, `BLIZZ_REGION=eu` |

Verified: `pytest -q` green (75 tests as of the dashboard's ilvl-plausibility/realm-name fixes, 2026-07-23). Live API confirmed working end to end:
